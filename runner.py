...
INCLUDE_OVERRIDE = ['ATGL.NS', 'FINEORG.NS', 'SHARDACROP.NS', 'RENUKA.NS', 'RHIM.NS', 'ADANIGREEN.NS', 'GAEL.NS', 'POWERGRID.NS', 'CRISIL.NS', 'GNFC.NS', 'EASEMYTRIP.NS', 'UFLEX.NS', 'CREDITACC.NS', 'NHPC.NS', 'THERMAX.NS', 'LINDEINDIA.NS', 'RATNAMANI.NS', 'SUMICHEM.NS', 'INGERRAND.NS', 'ADANIENT.NS', 'LEMONTREE.NS', 'GSFC.NS', 'SOLARINDS.NS', 'NH.NS', 'SUNPHARMA.NS', 'POWERINDIA.NS', 'JKPAPER.NS', 'MRPL.NS', 'BDL.NS', 'CGCL.NS', 'CGPOWER.NS', 'KEI.NS', 'TIINDIA.NS', 'WELCORP.NS', 'GRINDWELL.NS', 'GUJALKALI.NS']
WINDOW_TREND = 200
